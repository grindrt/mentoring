...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    MvcApplication.CounterHelper.Increment(Counters.LogIn);
                    _logger.Info("User {0} successfully logged in", user.UserName);
            ...
            _logger.Error("User {0} failed to log in", model.UserName);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.Info("User {0} successfully registreated", user.UserName);

                    MvcApplication.CounterHelper.Increment(Counters.Registration);

                    return RedirectToAction("Index", "Home");
                }

                AddErrors(result);
                _logger.Error("User {0} failed to register", model.UserName);
            }
        ...
        public ActionResult LogOff()
        {
            ...
            MvcApplication.CounterHelper.Increment(Counters.LogOff);
